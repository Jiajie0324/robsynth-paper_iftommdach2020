...
These constraints can e.g. be defined as vector loops between two leg chains \cite{Gogu2008} or one leg and the platform \cite{Merlet2006}.
The formulation of the full kinematic constraints on position level instead of velocity level has the advantage of providing a feasible residual for a gradient-based solution of the inverse kinematics problem, as presented by the authors in \cite{SchapplerTapOrt2019c}. 
%
