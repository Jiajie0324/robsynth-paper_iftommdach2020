...
\end{equation}
%
The nonlinear terms $\bm{\Phi}_{\bm{q}}$ and $\bm{\Phi}_{\bm{x}}$ can be calculated symbolically as described in \cite{SchapplerTapOrt2019c}.
The inversion of the $36 \times 36$-matrix should be performed numerically.
