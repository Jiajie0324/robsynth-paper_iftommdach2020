...
Nur wenige DH-Parameter gesetzt:
\begin{align}
\alpha_{1,\mathrm{DH}}=0, \quad \alpha_{5,\mathrm{DH}}, \quad \alpha_{6,\mathrm{DH}}=\pi/2
\end{align}
...
\captionof{figure}{Box plot of computation times of the particles of P6\underline{R}RRS in multiple repetitions corresponding to bars in Fig\,\ref{fig:figure_histogram_fitness}.}
\label{fig:figure_boxplot_comptime}
\end{figure}
...
\begin{figure}
    ...
    \label{fig:figure_energy_vs_tiltangle}
\end{figure}
