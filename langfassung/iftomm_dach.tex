...
From this it can be assumed that high condition numbers correlate with high material stress and the test of the condition number as a constraint would be sufficient.
