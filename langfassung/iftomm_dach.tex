...
However, for only few of them a specific application has been found despite numerous research demonstrators \cite{Merlet2006} focusing on single aspects of the robots.
Automatic dimensioning (dimensional synthesis) practical for all existing types of robots is necessary to select the robot that is suited best for a specific given application.
...
Efforts on the dimensional synthesis constitute a major part in the research of parallel robots, beginning in the early 2000s driven by German researchers in the area of machine tools \cite{MbarekNefCor2005,Krefft2006,FrindtKreHes2010} and international robotics research groups \cite{CarboneOttCec2007,KelaiaiaComZaa2012,JamwalHusXie2015}.
Until today, research was focused mainly on parallel robots with 
